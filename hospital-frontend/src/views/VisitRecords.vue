...
const resetSearch = () => { 
  ...
  .search-inputs { display: flex; gap: 20px; align-items: center; }
  .input-group input { padding: 8px; border: 1px solid #ddd; border-radius: 4px; }
  .btn-search { background: #004ea2; color: white; border: none; padding: 8px 25px; border-radius: 4px; cursor: pointer; }
  .btn-reset { background: white; border: 1px solid #ddd; padding: 8px 20px; border-radius: 4px; cursor: pointer; }
