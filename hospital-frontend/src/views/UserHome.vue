              ...
              <div class="dropdown-content">
                <div class="links-grid">
                  ...
                  <ul>
                    ...
                    <li><span class="bullet">•</span> 健康体检</li>
                    <li><span class="bullet">•</span> 在线问诊</li>
                  </ul>
                  <ul>
                ...
                <div class="dropdown-image">
                  <img src="https://img0.baidu.com/it/u=3073663688,4074266164&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500" alt="Doctor"/>
                </div>
              </div>
            </div>
          </div>
